{
    ...
    "schemas": {
      ...
      "UpdateConversation": {
        "properties": {
          ...
          "custom_fields": {
            "type": "object",
              "description": "Custom field attributes for this conversation. Do not include the custom_fields object if you do not wish to update the attributes. Including the custom_fields object with empty values will automatically remove the unspecified fields from the conversation."
          }
        }
      },
  ...
  "paths": {
    ...
    "/tags": {//{#100,222}
      ...
      "post": {
        "summary": "Create tag",
          "description": "Create a tag in the oldest team. This is a legacy endpoint. Use the Create company tag, Create team tag, or Create teammate tag endpoints instead.",
            "tags": [
              "Tags"
            ],
              "requestBody": {
